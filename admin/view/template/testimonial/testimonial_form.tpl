    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-author">Должность</label>
            <div class="col-sm-10">
              <input type="text" name="post" value="<?php echo $post; ?>" id="input-author" class="form-control" />
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-author">Изображение</label>
            <div class="col-sm-10">
