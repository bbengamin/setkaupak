...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo $back; ?>" data-toggle="tooltip" title="<?php echo $button_back; ?>" class="btn btn-primary"><i class="fa fa-reply"></i></a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <button type="button" value="<?php echo $order['order_id']; ?>" id="button-invoice<?php echo $order['order_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" data-toggle="tooltip" title="Выставить счет на email" class="btn btn-success"><i class="fa fa-envelope-o"></i></button></td>
                            </tr>
                            <?php } ?>
                            <?php } else { ?>
                            <tr>
    ...
    <script type="text/javascript"><!--
        $('#button-filter').on('click', function() {
            url = 'index.php?route=extension/payment/yamodule/invoice&token=<?php echo $token; ?>';
    ...
    <script type="text/javascript"><!--
        $('button[id^=\'button-invoice\']').on('click', function(e) {
            if (confirm('<?php echo $text_confirm; ?>')) {
                var node = this;
                $.ajax({
                    url: '<?php echo $store_url; ?>admin/index.php?route=extension/payment/yamodule/sendmail&token=<?php echo $token; ?>&order_id=' + $(node).val(),
                    dataType: 'json',
                    crossDomain: true,
                    beforeSend: function() {
                        $(node).button('loading');
