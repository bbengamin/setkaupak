...
*/
class ControllerExtensionYandexbuyCart extends Controller
{
					...
					foreach ($results as $result)
					{
						if ($this->config->get($result['code'] . '_status')) {
							...
							if ($quote)
							{
								...
								if($type == 'PICKUP')
								{
									$this->load->model('extension/yamodel/pokupki');
									$outlets = $this->model_extension_yamodel_pokupki->getOutlets();
